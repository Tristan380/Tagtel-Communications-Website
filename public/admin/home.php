...
<head>
    ...
    <title>Tagtel | Administrator	</title>
    <!-- Bootstrap Styles-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"> <?php echo $_SESSION["user"]; ?> </a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i> Quotation Requests</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Quotation Requests <small> </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 New Quotation Requests<span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
